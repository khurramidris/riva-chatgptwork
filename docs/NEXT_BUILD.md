...
- historical concepts/questions, population definition, response codebook, and collection dates;
- respondent-level or aggregate outcomes with lawful processing and training scope;
- at least one future study held outside model-team access;
- fieldwork cost, sample size, decision rule, and acceptable error tolerance;
- entity, product, geography, time, and semantic-family identifiers needed for hard splits.
