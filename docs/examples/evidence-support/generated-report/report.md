# Grocery delivery concept example
...
|---|---:|---:|
| Standard delivery | 40.5% | +0.0 percentage points |
| Flexible delivery | 40.3% | -0.1 percentage points |
| Neither plan | 19.2% | -21.3 percentage points |
...
- Offline heuristic baseline: no language model was called.
...
Study: catalog-workflow-example-v1. Input fingerprint: `d8c776f654e949f8e24a40fb61ceb598bf185f425dd013303fb514fb30b21819`.
