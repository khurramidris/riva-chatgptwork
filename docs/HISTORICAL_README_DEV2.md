# Historical README — development baseline

Archived verbatim below from `902a3eb`. Its release and pilot-readiness claims are historical and do not apply to the current release. See `SUPPORTED_OFFERING.md` for current claims.
